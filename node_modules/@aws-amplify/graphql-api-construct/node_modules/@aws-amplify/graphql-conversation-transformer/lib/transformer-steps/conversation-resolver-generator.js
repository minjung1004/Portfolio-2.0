...
class ConversationResolverGenerator {
    ...
    generateResolversForDirective(directive, ctx) {
        ...
        this.createConversationPipelineResolver(ctx, parentName, fieldName, capitalizedFieldName, functionDataSource, invokeLambdaFunction, directive);
    }
    ...
    createConversationPipelineResolver(ctx, parentName, fieldName, capitalizedFieldName, functionDataSource, invokeLambdaFunction, directive) {
        ...
        const conversationPipelineResolver = new graphql_transformer_core_1.TransformerResolver(parentName, fieldName, resolverResourceId, { codeMappingTemplate: invokeLambdaFunction }, ['init', 'auth', 'verifySessionOwner', 'writeMessageToTable', 'retrieveMessageHistory'], ['handleLambdaResponse', 'finish'], functionDataSource, runtime);
    ...
    addPipelineResolverFunctions(ctx, resolver, capitalizedFieldName, directive) {
        const initFunction = (0, init_resolver_1.initMappingTemplate)(directive);
        ...
        resolver.addJsFunctionToSlot('verifySessionOwner', verifySessionOwnerFunction, conversationSessionDDBDataSource);
    ...
    createAssistantResponseResolver(ctx, directive, capitalizedFieldName) {
        ...
        const assistantResponseResolver = new graphql_transformer_core_1.TransformerResolver('Mutation', directive.responseMutationName, assistantResponseResolverResourceId, { codeMappingTemplate: assistantResponseResolverFunction }, [], [], conversationMessageDataSource, graphql_transformer_core_1.APPSYNC_JS_RUNTIME);
